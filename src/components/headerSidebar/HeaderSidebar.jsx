    ...
    return (
        <>
            ...
            <header className="flex items-center justify-between p-4 z-10">
                <div
                    className="flex items-center justify-center w-1/5 h-24 bg-white text-black text-5xl font-normal shadow-md rounded-md pr-28"
                    style={{ fontFamily: 'Mongolian Baiti' }}
                >
                    LOGO
                </div>
                <div className="flex-1 flex items-center justify-center h-24 bg-white px-4 mx-8 rounded-md shadow-md">
                    ...
                    />
                    <button className="flex items-center gap-2 text-black text-lg mr-8">
                        <FontAwesomeIcon icon={faSliders} />
                        <span>Filters</span>
                    </button>
                </div>
                <div className="flex items-center justify-end w-1/5 h-24">
            ...
            {/* Sidebar */}
            <aside className="w-1/5 flex flex-col h-[84%] bg-white shadow-md rounded-md justify-between fixed mt-40">
                <div className="mt-4">
                    {menuItems.map((item, index) => (
                        <div
                            key={index}
                            className={`flex items-center gap-5 px-16 py-4 text-lg ${activeMenu === item.label
